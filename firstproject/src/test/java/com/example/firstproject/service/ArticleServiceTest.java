...
class ArticleServiceTest {
    ...
    void index() {
        ...
        List<Article> expected = new ArrayList<Article>(Arrays.asList(a,b,c));      // 배열을 리스트로 변환

        //2. 실제 데이터 (DB에 저장되어 있는 데이터)
    ...
    @Test
    @Transactional
    void update_성공1_존재하는_id와_title_content가_있는_dto_입력() {
        Long id =2L;
        String title = "222";
        String content = "나나나";
    ...
    @Test
    @Transactional
    void update_성공2_존재하는_id와_title만_있는_dto_입력() {
        Long id =2L;
        String title = "222";
        ArticleForm dto = new ArticleForm(id, title,null);
        Article expected = new Article(id, title,"222");
    ...
    void delete_성공_존재하는_id_입력() {
        Long id = 3L;
        Article expected = new Article(id,"다다다","333");
